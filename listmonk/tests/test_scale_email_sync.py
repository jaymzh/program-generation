...
class TestRegData:
    ...
    def test_get_csv_data(self, reg_data):
        ...
        with patch.object(reg_data, "_fetch_file_data", return_value=csv_content):
...
class TestListMonk:
    ...
    def test_add_subscriber_existing(self, mock_add_to_lists, mock_get, listmonk):
    ...
    @patch.object(ListMonk, "_post")
    @patch.object(ListMonk, "_get")
    def test_add_subscriber_dry_run(self, mock_get, mock_post, listmonk_dry_run):
    ...
    def test_report_stats_to_datadog(self, mock_metrics_api, mock_api_client, mock_time, listmonk):
    ...
    def test_report_stats_to_datadog_no_api_key(self, mock_config):
        ...
        lm = ListMonk(config_without_dd, dry_run=False, remove=False, prod=False)
...
class TestIntegration:
    ...
    def test_full_sync_workflow(
        ...
        listmonk = ListMonk(mock_config, dry_run=False, remove=False, prod=False)
